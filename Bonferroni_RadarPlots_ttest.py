...
for i in range(len(ROI_name)):
        ...
        nib.save(IMA_nib, "ttest_maskBonf_" + ROI_name[i] + "_" + name_modality + ".nii.gz")
    ...
    # create a dataframe to save the quantitative measures
        ...
        df.index = ROI_name
        df.to_excel(rep + "xls_" + name_modality + ".xls")
...
plt.savefig('ttest_radarplot_allvoxels_lesion_' + name_modality + '.png')
plt.close('all')
